...
<div class="divContent">
	<span class="spanPrice">支付金额：</span><span class="price_t">&yen;${orderBean.total }</span>
	<span class="spanOid">编号：${orderBean.oid }</span>
</div>
<form action="<c:url value='/OrderAction'/>" method="post" id="form1" target="_top">
<input type="hidden" name="flag" value="payOk"/>
...
<div class="divBank">
	...
	<!-- 	<a href="javascript:alert('支付成功！');" class="linkNext">立即支付</a>
		<input ref="javascript:alert('支付成功！');" type="submit" class="linkNext" value="立即支付"> -->
		<a href="javascript:$('#form1').submit();alert('支付成功！');"class="linkNext">立即支付</a>
	</div>
</div>
</form>
  </body>
