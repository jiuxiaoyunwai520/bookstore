		...
		<div class="container">
			<div class="form-group">
			 ...
			 <div class="form-group">
			  ...
			  <div class="form-group">
			    <label for="inputPassword1" class="col-sm-4 control-label">登录密码：</label>
			    <div class="col-sm-4">
			  ...
			  <div class="form-group">
			    ...
			    <div class="col-sm-4">
			      <input type="text" class="tdInput form-control" name="email" id="email" placeholder="请输入Email账号">
			    </div>
			  </div>
	  
	  		<div class="form-group">
			    <div class="col-sm-offset-4 col-sm-4">
			      <span id="emailError" class="spanError">${errors.email}</span>
			    </div>
			  </div>
